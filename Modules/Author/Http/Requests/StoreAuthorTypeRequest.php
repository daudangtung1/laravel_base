...
class StoreAuthorTypeRequest extends FormRequest
{
    ...
    {
        return [
            'name'        => ['required', 'string', 'max:100', 'unique:author_types,name'],
            'code'        => ['required', 'string', 'max:50', 'unique:author_types,code', 'alpha_dash'],
