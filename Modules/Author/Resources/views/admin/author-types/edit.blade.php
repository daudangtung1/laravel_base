    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.author-types.update', $authorType->id) }}" method="POST" id="author-type-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('name', $authorType->name) }}"
                               required>
                        @error('name')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('code', $authorType->code) }}"
                               required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea id="description"
                                  name="description"
                                  rows="3"
                                  class="form-control @error('description') is-invalid @enderror">{{ old('description', $authorType->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="color"
                                       ...
                                       value="{{ old('color_hex', $authorType->color_hex ?? '#6c757d') }}"
                                       style="max-width:50px;">
                                <input type="text"
                                       id="color_hex"
                                       name="color_hex"
                                       class="form-control @error('color_hex') is-invalid @enderror"
                                       value="{{ old('color_hex', $authorType->color_hex) }}"
                                       placeholder="#RRGGBB"
                                       maxlength="7">
                                @error('color_hex')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('sort_order', $authorType->sort_order) }}"
                                   min="0">
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input"
                                       ...
                                       name="is_active"
                                       value="1"
                                       {{ old('is_active', $authorType->is_active) ? 'checked' : '' }}>
